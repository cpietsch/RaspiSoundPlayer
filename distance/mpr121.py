...
def setup(address):
	...
	bus.write_byte_data(address, ATO_CFGU, 0xC9);
	bus.write_byte_data(address, ATO_CFGL, 0x82); 
	bus.write_byte_data(address, ATO_CFGT,0xb5);
	bus.write_byte_data(address, ATO_CFG0, 0x1B);
